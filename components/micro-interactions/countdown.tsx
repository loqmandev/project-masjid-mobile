        ...
        transform: [
          {
            translateY: withDelay(
              animationDelay,
              withTiming(enterFinal.translateY, timingConfig),
            ),
          },
          {
            scale: withDelay(
              animationDelay,
              withTiming(enterFinal.scale, timingConfig),
            ),
          },
        ],
      },
...
export const CountdownTimer: React.FC<CountdownTimerProps> = ({
  ...
  const separatorStyle = {
    ...
    fontWeight: styling.fontWeight,
    marginHorizontal: styling.separatorMargin.horizontal,
  };

  return (
    <View style={[styles.countdownWrapper, customization.containerStyle]}>
      {isFinished ? (
        <Text style={[numberStyle, { textAlign: "center" }]}>
          {styling.finishText}
        </Text>
      ) : (
        <View style={styles.countdownContainer}>
          {/* Numbers and separators row */}
          ...
          {styling.showLabels && (
            <View style={styles.labelsRow}>
              {shouldShowYears && (
                <>
                  <View style={styles.labelContainer}>
                    <Text style={[styles.labelText, labelStyle]}>YEARS</Text>
                  </View>
                  {styling.showSeparators && <View style={styles.separatorSpacer} />}
                </>
              )}
              {shouldShowMonths && (
                <>
                  <View style={styles.labelContainer}>
                    <Text style={[styles.labelText, labelStyle]}>MONTHS</Text>
                  </View>
                  {styling.showSeparators && <View style={styles.separatorSpacer} />}
                </>
              )}
              {shouldShowDays && (
                <>
                  <View style={styles.labelContainer}>
                    <Text style={[styles.labelText, labelStyle]}>DAYS</Text>
                  </View>
                  {styling.showSeparators && <View style={styles.separatorSpacer} />}
                </>
              )}
              {shouldShowHours && (
                <>
                  <View style={styles.labelContainer}>
                    <Text style={[styles.labelText, labelStyle]}>HOURS</Text>
                  </View>
                  {styling.showSeparators && <View style={styles.separatorSpacer} />}
                </>
              )}
              {shouldShowMinutes && (
                <>
                  <View style={styles.labelContainer}>
                    <Text style={[styles.labelText, labelStyle]}>MINS</Text>
                  </View>
                  {styling.showSeparators && <View style={styles.separatorSpacer} />}
                </>
              )}
              <View style={styles.labelContainer}>
                <Text style={[styles.labelText, labelStyle]}>SECS</Text>
              </View>
            </View>
          )}
        </View>
